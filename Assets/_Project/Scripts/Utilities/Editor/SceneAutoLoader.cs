...
namespace AdventurerVillage.Utilities
{
   /// <summary>
    ...
    internal static class SceneAutoLoader
    {
        ...
        [MenuItem("SceneManagement/Scene Autoload/Select Master Scene")]
        private static void SelectMasterScene()
        {
            string masterScene = EditorUtility.OpenFilePanel("Select Master Scene", "Assets/_Project/Scenes/", "unity");
        ...
        [MenuItem("SceneManagement/Scene Autoload/Load Master On Play", true)]
        private static bool ShowLoadMasterOnPlay()
        {
            return !LoadMasterOnPlay;
        }

        [MenuItem("SceneManagement/Scene Autoload/Load Master On Play")]
        private static void EnableLoadMasterOnPlay()
        {
            LoadMasterOnPlay = true;
        }

        [MenuItem("SceneManagement/Scene Autoload/Don't Load Master On Play", true)]
        private static bool ShowDontLoadMasterOnPlay()
        {
            return LoadMasterOnPlay;
        }

        [MenuItem("SceneManagement/Scene Autoload/Don't Load Master On Play")]
